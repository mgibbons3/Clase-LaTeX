...
\date{Esta versión: June 2021} % Fecha actual

%%% Tablas
        \input{ref_table1_pre.tex}
        \input{ref_table2_pre.tex}
...
\begin{frame}[fragile]{¿Cómo funciona \LaTeX?}
	\begin{itemize}
        ...
        \item El compilador de \LaTeX \; interpreta los comandos y los convierte en un lindo documento.
	\end{itemize}
    \begin{center}
